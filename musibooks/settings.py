"""
Django settings for musibooks project.
...
SOCIAL_AUTH_SPOTIFY_SCOPE = ['ugc-image-upload', 'playlist-read-private',
...
WSGI_APPLICATION = 'musibooks.wsgi.application'
